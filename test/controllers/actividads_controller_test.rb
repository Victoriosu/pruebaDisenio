...
class ActividadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create actividad" do
    assert_difference('Actividad.count') do
      post actividads_url, params: { actividad: { estado: @actividad.estado, fecha: @actividad.fecha, nombre: @actividad.nombre } }
    end
  ...
  test "should update actividad" do
    patch actividad_url(@actividad), params: { actividad: { estado: @actividad.estado, fecha: @actividad.fecha, nombre: @actividad.nombre } }
